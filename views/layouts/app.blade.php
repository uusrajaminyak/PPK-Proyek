            ...
            <div class="flex justify-between items-center h-16">
                ...
                <nav class="hidden md:flex items-center gap-6 text-sm font-medium">
                    ...
                    <a href="{{ route('officer.reports.index') }}" 
                        ...
                        Antrean Petugas
                        <span class="text-[10px] bg-purple-100 text-purple-700 px-1.5 py-0.5 rounded font-bold">FR-11</span>
                    </a>
                    ...
                    <a href="{{ route('officer.facilities.index') }}" 
                        ...
                        Status Fasilitas
                        <span class="text-[10px] bg-emerald-100 text-emerald-700 px-1.5 py-0.5 rounded font-bold">FR-12</span>
                    </a>
                </nav>
